...
def test_get_data_bounds():
    ae(_get_data_bounds(None), [[-1.0, -1.0, 1.0, 1.0]])

    db0 = np.array([[0, 1, 4, 5], [0, 1, 4, 5], [0, 1, 4, 5]])
...
def test_binary_search():
    ...
    ac(_binary_search(f, 0, 1), 0.4)
    ac(_binary_search(f, 0, 0.3), 0.3)
    ac(_binary_search(f, 0.5, 1), 0.5)
